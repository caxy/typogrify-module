...
/**
 * @file
 * Contains \Drupal\typogrify\Plugin\Filter\FilterTypogrify.
 */
...
//    );
    ...
    $form['smartypants_enabled'] = array(
      ...
      '#default_value' => $this->settings['smartypants_enabled'],
    );
    ...
    $form['smartypants_hyphens'] = array(
      ...
      '#default_value' => $this->settings['smartypants_hyphens'],
      '#options' => array(
    ...
    $form['space_hyphens'] = array(
      ...
      '#default_value' => $this->settings['space_hyphens'],
    );
    ...
    $form['widont_enabled'] = array(
      ...
      '#default_value' => $this->settings['widont_enabled'],
    );
    ...
    $form['hyphenate_shy'] = array(
      ...
      '#default_value' => $this->settings['hyphenate_shy'],
    );
    ...
    $form['space_to_nbsp'] = array(
      ...
      '#default_value' => $this->settings['space_to_nbsp'],
    );
    ...
    $form['wrap_caps'] = array(
      '#type' => 'checkbox',
      '#title' => t('Wrap caps'),
      '#default_value' => $this->settings['wrap_caps'],
    );
    ...
    $form['wrap_ampersand'] = array(
      ...
      '#default_value' => $this->settings['wrap_ampersand'],
    );
    ...
    $form['wrap_abbr'] = array(
      ...
      '#default_value' => $this->settings['wrap_abbr'],
      '#options' => array(
        0 => t('Do nothing'),
        4 => t('Insert no space'),
    ...
    $form['wrap_numbers'] = array(
      ...
      '#default_value' => $this->settings['wrap_numbers'],
      '#options' => array(
        0 => t('Do nothing'),
        1 => t('“U+202F“ Narrow no-break space'),
        2 => t('“U+2009“ Thin space'),
    ...
    $form['wrap_initial_quotes'] = array(
      ...
      '#default_value' => $this->settings['wrap_initial_quotes'],
    );
    ...
    $form['ligatures'] = array(
      ...
      '#default_value' => $this->settings['ligatures'],
    );
    ...
    $form['arrows'] = array(
      ...
      '#default_value' => $this->settings['arrows'],
    );
    ...
    $form['fractions'] = array(
      ...
      '#default_value' => $this->settings['fractions'],
    );
    ...
    $form['quotes'] = array(
      ...
      '#default_value' => $this->settings['quotes'],
    );

    // Version Information Settings.
    $version_strings = array();
    $version_strings[] = t('SmartyPants PHP version: !version', array(
      '!version' => \Drupal::l(SmartyPants::SMARTYPANTSLIB_VERSION, Url::fromUri('http://www.michelf.com/projects/php-smartypants/')),
    ));
